Here we have a sockets application made in node ( TS + <a href="https://nodejs.org/api/net.html" target="_blank">net module</a>). A small chat was made for real-time communication between two customers.
